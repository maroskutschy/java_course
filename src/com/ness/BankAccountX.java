...
//        // calling constructor from constructor - must be first statement on constructor body
    ...
    public BankAccountX(String number, double balance, String customerName,
    ...
    public BankAccountX(String customerName, String customerEmailAddress, String customerPhoneNumber) {
